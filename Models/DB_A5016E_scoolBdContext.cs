...
{
    public partial class DB_A5016E_scoolBdContext : DbContext
    {
        public DB_A5016E_scoolBdContext()
        {
        }

        public DB_A5016E_scoolBdContext(DbContextOptions<DB_A5016E_scoolBdContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=SQL5041.site4now.net;Initial Catalog=DB_A5016E_scoolBd;User Id=DB_A5016E_scoolBd_admin;Password=Villanueva123;");
            }
        }
